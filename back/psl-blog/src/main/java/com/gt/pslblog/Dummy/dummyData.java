...
public class dummyData {
    ...
    public void insertData() {
        ...
        Comment comment1 = Comment.builder()
                .name("Giovani Comentário1")
                .text("Este é um comentário - campo de texto")
                .instant(LocalDateTime.now())
                .post(post1)
                .build();

        Comment comment2 = Comment.builder()
                .name("Giovani Comentário2")
                .text("Este é um comentário - campo de texto 2")
                .instant(LocalDateTime.now())
                .post(post1)
                .build();

        Comment comment3 = Comment.builder()
                .name("Giovani Comentário 3")
                .text("Este é um comentário - campo de texto")
                .instant(LocalDateTime.now())
                .post(post1)
                .build();
